...
require_env UPSTREAM_PROXY_HOST
require_env UPSTREAM_PROXY_PORT
...
PROXY_CORE_UPSTREAM_MODE=$PROXY_CORE_UPSTREAM_MODE
SURGE_HTTP_HOST=$SURGE_HTTP_HOST
SURGE_HTTP_PORT=$SURGE_HTTP_PORT
SURGE_SOCKS_HOST=$SURGE_SOCKS_HOST
SURGE_SOCKS_PORT=$SURGE_SOCKS_PORT
SURGE_PROXY_WAIT_ATTEMPTS=$SURGE_PROXY_WAIT_ATTEMPTS
...
install -m 755 "$REPO_ROOT/scripts/setup_dmit_iproyal_stack.sh" "$RUNTIME_BIN/setup_dmit_iproyal_stack.sh"
